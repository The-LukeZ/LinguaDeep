/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 502ee00baab7b76c869e9cf1f7e0756f)
// Runtime types generated with workerd@1.20251210.0 2026-01-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DataCache";
	}
	interface Env {
		...
		DATA_CACHE: DurableObjectNamespace<import("./src/index").DataCache>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_PUBLIC_KEY" | "DISCORD_APPLICATION_ID" | "DISCORD_TOKEN" | "DISCORD_SECRET" | "ENCRYPTION_KEY">> {}
}
